...
/****** Object:  Database [DevelopmentHell.Hubba.CollaboratorProfiles]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE DATABASE [DevelopmentHell.Hubba.CollaboratorProfiles]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DevelopmentHell.Hubba.CollaboratorProfiles', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\DevelopmentHell.Hubba.CollaboratorProfiles.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DevelopmentHell.Hubba.CollaboratorProfiles_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\DevelopmentHell.Hubba.CollaboratorProfiles_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
GO
/****** Object:  Login [NT SERVICE\Winmgmt]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [NT SERVICE\Winmgmt] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT SERVICE\SQLWriter]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [NT SERVICE\SQLWriter] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT SERVICE\SQLTELEMETRY$SQLEXPRESS]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [NT SERVICE\SQLTELEMETRY$SQLEXPRESS] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT Service\MSSQL$SQLEXPRESS]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [NT Service\MSSQL$SQLEXPRESS] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [NT AUTHORITY\SYSTEM]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [NT AUTHORITY\SYSTEM] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [DevelopmentHell.Hubba.SqlUser.User]    Script Date: 4/18/2023 10:07:48 PM ******/
...
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [DevelopmentHell.Hubba.SqlUser.Notification]    Script Date: 4/18/2023 10:07:48 PM ******/
...
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [DevelopmentHell.Hubba.SqlUser.Logging]    Script Date: 4/18/2023 10:07:48 PM ******/
...
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [DevelopmentHell.Hubba.SqlUser.CollaboratorProfile]    Script Date: 4/18/2023 10:07:48 PM ******/
...
GO
/****** Object:  Login [DESKTOP-NZXT\NZXT ASRock]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [DESKTOP-NZXT\NZXT ASRock] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/****** Object:  Login [BUILTIN\Users]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [BUILTIN\Users] FROM WINDOWS WITH DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english]
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [##MS_PolicyTsqlExecutionLogin##]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [##MS_PolicyTsqlExecutionLogin##] WITH PASSWORD=N'6YuvMJvmarwPFZP/OehmrqDoEfMbqT0YRZomtRw6AmM=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
ALTER LOGIN [##MS_PolicyTsqlExecutionLogin##] DISABLE
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [##MS_PolicyEventProcessingLogin##]    Script Date: 4/18/2023 10:07:48 PM ******/
CREATE LOGIN [##MS_PolicyEventProcessingLogin##] WITH PASSWORD=N'IRB99Fn2Ft4kvcuIn86NkWuapWel/aYf9znR2OfA/vk=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
...
GO
/****** Object:  User [DevelopmentHell.Hubba.SqlUser.CollaboratorProfile]    Script Date: 4/18/2023 10:07:48 PM ******/
...
GO
/****** Object:  FullTextCatalog [CollaboratorsCatalog]    Script Date: 4/18/2023 10:07:49 PM ******/
CREATE FULLTEXT CATALOG [CollaboratorsCatalog] WITH ACCENT_SENSITIVITY = ON
AUTHORIZATION [dbo]
GO
/****** Object:  Table [dbo].[CollaboratorFiles]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Collaborators]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Files]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserVotes]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_Collaborators]    Script Date: 4/18/2023 10:07:49 PM ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_Collaborators] ON [dbo].[Collaborators]
(
	[OwnerId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  FullTextIndex     Script Date: 4/18/2023 10:07:49 PM ******/
...
GO
ALTER TABLE [dbo].[Collaborators]  WITH CHECK ADD  CONSTRAINT [FK_Collaborators_Files] FOREIGN KEY([ProfilePicture])
REFERENCES [dbo].[Files] ([FileId])
GO
ALTER TABLE [dbo].[Collaborators] CHECK CONSTRAINT [FK_Collaborators_Files]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[CurateCollaborators]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SearchCollaborators]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_Collaborators]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Trigger [dbo].[trg_UserVotes]    Script Date: 4/18/2023 10:07:49 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
  IF EXISTS (
    SELECT 1
    FROM [DevelopmentHell.Hubba.Users].dbo.UserAccounts AS ua
    WHERE NOT EXISTS (
      SELECT 1
      FROM inserted AS i
      WHERE i.AccountId = ua.Id
    )
  )
  BEGIN
    RAISERROR('Referenced record does not exist in target database', 16, 1)
