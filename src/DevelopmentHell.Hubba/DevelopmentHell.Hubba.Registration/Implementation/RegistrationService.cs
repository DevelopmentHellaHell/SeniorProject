...
namespace DevelopmentHell.Hubba.Registration
{
    ...
    {
        private readonly string _connectionString = String.Format(@"Server={0};Database=DevelopmentHell.Hubba.Accounts;Encrypt=false;User Id=DevelopmentHell.Hubba.SqlUser.Registration;Password=password", ConfigurationManager.AppSettings["AccountServer"]);
