...
{
    [TestClass]
    public class AccountDeletionDALUnitTests
    {
        ...
        public AccountDeletionDALUnitTests()
        {
        ...
        public async Task DeleteVerifiedAccount()
        {
            ...
            // Act
            Result actual = await _userAccountDataAccess.Delete(accountId).ConfigureAwait(false);
        ...
        public async Task CountingAdminAccounts()
        {
            ...
            // Act
            Result<int> countAdmin1 = await _userAccountDataAccess.CountAdmin().ConfigureAwait(false);
            ...
            // Act
            Result<int> countAdmin2 = await _userAccountDataAccess.CountAdmin().ConfigureAwait(false);
