...
CREATE LOGIN [distributor_admin] WITH PASSWORD=N'ttYLGVjyeECkQawUPekQhGEys+tGBK7ye+92PBzTFRY=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
...
CREATE LOGIN [##MS_PolicyTsqlExecutionLogin##] WITH PASSWORD=N'x53jrNvfiqDZG70qghMHHI0QDxRNdjQjaEv7u4MJXYo=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
ALTER LOGIN [##MS_PolicyTsqlExecutionLogin##] DISABLE
GO
/* For security reasons the login is created disabled and with a random password. */
/****** Object:  Login [##MS_PolicyEventProcessingLogin##]    Script Date: 5/1/2023 3:52:03 PM ******/
CREATE LOGIN [##MS_PolicyEventProcessingLogin##] WITH PASSWORD=N'QKJ867iVSzraQlcZrSd+CZQVGV3KK/u30FmmeU+hj4c=', DEFAULT_DATABASE=[master], DEFAULT_LANGUAGE=[us_english], CHECK_EXPIRATION=OFF, CHECK_POLICY=ON
GO
