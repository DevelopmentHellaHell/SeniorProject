...
namespace DevelopmentHell.Hubba.SqlDataAccess
{
    public class BookedTimeFrameDataAccess : IBookedTimeFrameDataAccess
    {
                ...
                valuesList.Add(new Dictionary<string, object>()
                                {
                                    ...
                                    { "EndDateTime", timeframe.StartDateTime }
                                });
            }
        ...
        public Task<Result> DeleteBookedTimeFrames(int bookingId, int listingId, int availabilityId, DateTime startDateTime, DateTime endDateTime)
        {
            throw new NotImplementedException();
        }
    }
