...
namespace DevelopmentHell.Hubba.SqlDataAccess.Abstractions
{
    public interface IProjectShowcaseDataAccess
    {
        ...
        Task<Result<string>> GetCommentShowcase(int commentId);
        ...
        Task<Result<List<Dictionary<string, object>>>> GetCommentReports(int commentId);
        ...
        Task<Result<bool?>> GetCommentUserRating(int commentId, int voterId);
        Task<Result<int>> UpdateCommentRating(int commentId, int difference);
        Task<Result> InsertUserCommentRating(int commentId, int voterId, bool isUpvote);
        Task<Result> UpdateUserCommentRating(int commentId, int voterId, bool isUpvote);
