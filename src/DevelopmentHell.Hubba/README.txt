To run schema scripts, open the solution file in Visual studio then go under DAL >> DS_schemas in the solution explorer to find the schema scripts to setup the database.
