    ...
    return(
        <div className="collaborator-wrapper">
            ...
            <div className="remove-collaborator">
                <p className="inline-text">Remove collaborator your collaborator profile. This will permanently clear all data about your collaborator profile.</p>
            ...
            <div className="delete-collaborator">
                <p className="inline-text">Delete collaborator your collaborator profile. This will permanently delete your collaborator profile.</p>
